...
try:
    ...
    # Ensure you create a file at .streamlit/secrets.toml with key = "YOUR_API_KEY"
...
WEIGHTS_PATH = 'models.h5'  # <-- Model weights file name in the root directory
NUM_CLASSES = 38 # <-- FIX: Set to 38 to match the 38 class names listed below
IMAGE_SIZE = 224  # <-- Input size for MobileNetV2

CONFIDENCE_THRESHOLD = 0.85

## =============================================================================
## 1. KNOWLEDGE BASE & CLASS NAMES
## =============================================================================
...
# --- FULL CLASS NAMES (38 classes from PlantVillage dataset) ---
FULL_CLASS_NAMES = [
...
def load_disease_model(weights_path):
    ...
    try:
        ...
        model = Sequential([
            ...
            Dense(256, activation='relu'),  # <--- FIX IMPLEMENTED: Matches (1280, 512) required shape
            Dropout(0.5),
            Dense(NUM_CLASSES, activation='softmax')  # NUM_CLASSES is 38
        ])
        ...
        # This error handling now catches the shape mismatch if it somehow persists
